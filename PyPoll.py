...
for candidate_name in candidate_votes:
    ...
    #to do: print out each candidates name, vote count, and percentage of vote to terminal
...
# to do: print out the winning candidate, vote count, and percentage of vote to terminal
